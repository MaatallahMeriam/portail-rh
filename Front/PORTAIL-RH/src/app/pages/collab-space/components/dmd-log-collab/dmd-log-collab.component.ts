...
@Component({
  ...
  templateUrl: './dmd-log-collab.component.html',
  styleUrl: './dmd-log-collab.component.scss'
})
export class DmdLogCollabComponent implements OnInit {
