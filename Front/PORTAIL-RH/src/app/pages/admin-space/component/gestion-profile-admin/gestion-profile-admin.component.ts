...
@Component({
  ...
  templateUrl: './gestion-profile-admin.component.html',
  styleUrl: './gestion-profile-admin.component.scss',
...
export class GestionProfileAdminComponent implements OnInit, AfterViewInit {
