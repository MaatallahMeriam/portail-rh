...
@Component({
  ...
  templateUrl: './pointage-collab.component.html',
  styleUrl: './pointage-collab.component.scss'
})
export class PointageCollabComponent implements OnInit, OnDestroy {
