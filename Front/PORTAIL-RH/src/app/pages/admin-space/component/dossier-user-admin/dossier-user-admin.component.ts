...
@Component({
  selector: 'app-dossier-user-admin',
  standalone: true,
  imports: [ SidebarAdminComponent ,
    CommonModule, FormsModule, HeaderComponent, RightSidebarComponent
  ],
  templateUrl: './dossier-user-admin.component.html',
  styleUrl: './dossier-user-admin.component.scss'
})
export class DossierUserAdminComponent implements OnInit {
