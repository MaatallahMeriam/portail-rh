...
@Component({
  selector: 'app-espace-doc-manager',
  standalone: true,
  ...
  templateUrl: './espace-doc-manager.component.html',
  styleUrl: './espace-doc-manager.component.scss'
})
export class EspaceDocManagerComponent implements OnInit {
