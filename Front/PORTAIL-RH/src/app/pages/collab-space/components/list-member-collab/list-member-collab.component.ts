...
@Component({
  selector: 'app-list-member-collab',
  standalone: true,
  imports: [
    CommonModule,
    MatIconModule,
  ...
  templateUrl: './list-member-collab.component.html',
  styleUrls: ['./list-member-collab.component.scss'],
  animations: [
    trigger('fadeIn', [
      transition(':enter', [
...
export class ListMemberCollabComponent implements OnInit {
