...
import { DemandeCongesDialogComponent } from '../dmd-conges-collab/demande-conges-dialog/demande-conges-dialog.component';
import { NgxDatatableModule } from '@swimlane/ngx-datatable';

@Component({
  selector: 'app-dmd-conges',
  standalone: true,
  templateUrl: './dmd-conges.component.html',
  styleUrls: ['./dmd-conges.component.scss'],
  imports: [
    NgxDatatableModule,
    HeaderComponent,
    SidebarComponent,
...
export class DmdCongesComponent implements OnInit {
