...
import { DemandeCongesDialogComponent } from '../dmd-conges-RH/demande-conges-dialog/demande-conges-dialog.component';
import { NgxDatatableModule } from '@swimlane/ngx-datatable';

@Component({
  selector: 'app-dmd-conges-rh',
  standalone: true,
  imports: [
    NgxDatatableModule,
    HeaderComponent,
  ...
  templateUrl: './dmd-conges.component.html',
  styleUrl: './dmd-conges.component.scss',
  providers: [provideNativeDateAdapter()],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DmdCongesComponentRH implements OnInit {
